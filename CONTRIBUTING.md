If you wish to add an ID package to the list please:

1. Fork the repository.
2. Add the package following the format of the existing entries.
3. In your pull request, explain clearly why you think your submission is awesome. Can be brief. If you are replacing a library, state clearly why your submission is better than the existing library.
